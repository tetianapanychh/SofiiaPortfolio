 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".popup__images")) new Swiper(".popup__images", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        function animOnScroll() {
            ...
            animItems.forEach((animItem => {
                ...
                if (pageOffset > animItemOffset - animItemPoint && pageOffset < animItemOffset + animItemHeight) animItem.classList.add("--active"); else if (!animItem.classList.contains("anim-no-hide")) animItem.classList.remove("--active");
            }));
        }
        ...
        function handleLoad() {
            ...
            if (preloader && !preloader.classList.contains("loaded")) setTimeout((() => {
                animOnScroll();
            }), 1e3); else animOnScroll();
        }
        ...
        function animateCascadeSlide() {
            ...
            if (window.scrollY > cascadeSliderOffsetY && window.scrollY < cascadeSliderOffsetYBottom) for (let i = 0; i < cascadeSlidesCount; i++) {
                ...
                cascadeSlides[i].style.top = "6.25rem";
            }
        }
        isWebp();
        menuInit();
